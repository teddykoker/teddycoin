...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/teddycoin-project/teddycoin>";
    const std::string URL_WEBSITE = "<https://teddycoin.org>";
