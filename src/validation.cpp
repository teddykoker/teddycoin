...
#if defined(NDEBUG)
# error "Teddycoin cannot be compiled without assertions."
#endif
...
const std::string strMessageMagic = "Teddycoin Signed Message:\n";
                              ...
                              bool fOverrideMempoolLimit, const CAmount& nAbsurdFee, std::vector<COutPoint>& coins_to_uncache)
{
...

    {
        ...
        {
            LogPrint(BCLog::MEMPOOL, "replacing tx %s with %s for %s TKC additional fees, %d delta bytes\n",
