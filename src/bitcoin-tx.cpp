...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s teddycoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  teddycoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded teddycoin transaction") + "\n" +
              "  teddycoin-tx [options] -create [commands]   " + _("Create hex-encoded teddycoin transaction") + "\n" +
              "\n";
